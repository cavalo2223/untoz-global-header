(() => {
  ...
  function render(target, options = {}) {
    ...
    const link = (key, label) => `
      <a class="untoz-global-header__link ${config.active === key ? 'is-active' : ''}" href="${escapeHtml(config.links[key])}" data-untoz-key="${key}">${label}</a>`;

    target.innerHTML = `
      <header class="untoz-global-header" data-untoz-site="${escapeHtml(config.site)}">
        <div class="untoz-global-header__inner">
          <a class="untoz-global-header__brand" href="${escapeHtml(config.links.universe)}" aria-label="Untoz">
            <span class="untoz-global-header__mark">U</span>
            <span class="untoz-global-header__wordmark">UNTOZ</span>
          </a>

          <nav class="untoz-global-header__nav" aria-label="Untoz">
            ${link('universe', 'Universe')}
            <div class="untoz-global-header__menu">
              <button class="untoz-global-header__menu-button" type="button" aria-expanded="false">
                Entertainment <span class="untoz-global-header__chevron">⌄</span>
              </button>
              <div class="untoz-global-header__dropdown" role="menu">
                <div class="untoz-global-header__dropdown-title">Entertainment</div>
                <div class="untoz-global-header__dropdown-grid">
                  <a class="untoz-global-header__dropdown-link" href="${escapeHtml(config.links.plus)}">Untoz+</a>
                  <a class="untoz-global-header__dropdown-link" href="${escapeHtml(config.links.music)}">Untoz Music</a>
                  <a class="untoz-global-header__dropdown-link" href="#">Untoz Kids</a>
                  <a class="untoz-global-header__dropdown-link" href="#">Task Movies</a>
                </div>
              </div>
            </div>
            ${link('news', 'News')}
          ...
          <a class="untoz-global-header__account" href="${escapeHtml(config.accountUrl)}">
